...
@section('content')
    ...
    <div id="content">
        <div id="zdjecie_seansu">
            <img src={{ Storage::url($path.$screening->poster_filename) }} alt="" width="400" height="500"><br>
        </div>
        ...
        <div id="ktory_film">
            <h1>Film</h1>
            <h3><a href={{ route('films.show',  $screening->film_id) }} title="Kliknij aby wyświetlić informacje o filmie">{{ $screening->film->title }}</h3>
        </div>
    </div>
