...
<div class ="formularz">
    <form action='{{ route("admin.users.update", $user->id) }}' method='post'>
        @csrf
		@method("PATCH")
        <div class="pole_formularza_maly_odstep"><label>Adres e-mail:*<br><input type="checkbox" id="chbx_email" onclick="disable('chbx_email','email')"><input type="text" id="email" name="email" value="{{ $user->email }}"  disabled /></label></div>
